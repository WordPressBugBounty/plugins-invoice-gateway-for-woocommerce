...
jQuery(document).ready(function ($) {
  ...
  $(".plugin-installer").click(function (e) {
    ...
    $button.prepend('<span class="spinner is-active" style="float: none; margin-top: 0;"></span>');
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response && response.success) {
          ...
          Toast.fire({
            icon: "success",
            title: response.data && response.data.message ? response.data.message : "Plugin installed successfully!"
          });
          ...
          if (response.data && response.data.redirect_url) {
            ...
            goToSettingsButton.removeClass("hidden").text(settings.go_to_settings_text || "Go to Settings").css({
          ...
          Toast.fire({
            icon: "error",
            title: response && response.data && response.data.message ? response.data.message : settings.install_error_message
          });
